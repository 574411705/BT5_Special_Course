# 1 "E:/SEGGER/source/thumb_crt0.s"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "E:/SEGGER/source/thumb_crt0.s"
# 100 "E:/SEGGER/source/thumb_crt0.s"
  .syntax unified
...
_start:
  ...
  mov sp, r1
# 139 "E:/SEGGER/source/thumb_crt0.s"
1:
  ...
  movs r2, #2
  msr control, r2
# 160 "E:/SEGGER/source/thumb_crt0.s"
1:
  ...
  bl memory_copy
# 221 "E:/SEGGER/source/thumb_crt0.s"
  ...
  movs r2, #0
  bl memory_set
# 244 "E:/SEGGER/source/thumb_crt0.s"
...
ctor_end:
  ...
  mov lr, r0
  mov r12, sp
# 290 "E:/SEGGER/source/thumb_crt0.s"
  movs r0, #0
  movs r1, #0
  ...
  .thumb_func
exit:
# 331 "E:/SEGGER/source/thumb_crt0.s"
exit_loop:
  b exit_loop
...
1:
  ...
  .word 0x0
# 439 "E:/SEGGER/source/thumb_crt0.s"
